...
public class MedicineDeliveryObj extends ServiceRequestObjs {
    ...
    public MedicineDeliveryObj(String nodeID, int assigneeID, int userID, String medicineName, String doseQuantity, String doseMeasure, String specialInstructions, String signature) {
